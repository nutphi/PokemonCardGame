 ...
 */
public class DestatusAbility extends Ability {
    ...
    public DestatusAbility(AbilityTarget target, AbilityType type) {
        this.target = target;
        this.type = type;
    }

    //injection dependency
    public DestatusAbility(AbilityTarget target, AbilityType type, Ability subAbility) {
        this.target = target;
        this.type = type;
